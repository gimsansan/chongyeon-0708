...
> **이 파일은 `3-branch`의 인계문을 가져온 것이다. 이 브랜치의 현재 인계문이 아니다.**
> 오디오 무음 수정(`0b6c216`·`370359c`)의 작업 기록으로 보존한다.
> 이 브랜치의 현재 인계문은 [`doc/handoff.md`](./handoff.md)이고, 여기 언급된
> `doc/handoff_2.md`는 이 브랜치에 없다.
