...
// Rive .riv 파일이 android/app/src/main/res/raw/ 또는 해당 경로에 있을 때만 true
const REFRI_RIVE_AVAILABLE = true;

// assets/mono WebP 이미지 (추가 시 여기 넣고 label 수정)
const MONO_ITEMS: { id: string; label: string; imageSource: number; sound?: any }[] = [
  { id: 'asparagus', label: '아스파라거스', imageSource: require('../../../assets/mono/asparagus.webp'), sound: require('../../../assets/sounds/refri_flac/아스파라거스.flac') },
  { id: 'baechu', label: '배추', imageSource: require('../../../assets/mono/baechu.webp'), sound: require('../../../assets/sounds/refri_flac/배추.flac') },
  { id: 'broccoli', label: '브로콜리', imageSource: require('../../../assets/mono/broccoli.webp'), sound: require('../../../assets/sounds/refri_flac/브로콜리.flac') },
  { id: 'buritto', label: '브리토', imageSource: require('../../../assets/mono/buritto.webp'), sound: require('../../../assets/sounds/refri_flac/브리토.flac') },
  { id: 'cake', label: '케이크', imageSource: require('../../../assets/mono/cake.webp'), sound: require('../../../assets/sounds/refri_flac/케이크.flac') },
  { id: 'cola', label: '콜라', imageSource: require('../../../assets/mono/cola.webp'), sound: require('../../../assets/sounds/refri_flac/콜라.flac') },
 /*  { id: 'corn', label: '옥수수', imageSource: require('../assets/mono/corn.webp'), sound: require('../assets/sounds/refri_flac/옥수수.flac') },
  { id: 'radish', label: '무', imageSource: require('../assets/mono/radish.webp'), sound: require('../assets/sounds/refri_flac/무.flac') },
  { id: 'dotori', label: '도토리', imageSource: require('../assets/mono/dotori.webp'), sound: require('../assets/sounds/refri_flac/도토리.flac') },
  { id: 'gaji', label: '가지', imageSource: require('../assets/mono/gaji.webp'), sound: require('../assets/sounds/refri_flac/가지.flac') },
  { id: 'ginger', label: '생강', imageSource: require('../assets/mono/ginger.webp'), sound: require('../assets/sounds/refri_flac/생강.flac') },
  { id: 'ice', label: '아이스크림', imageSource: require('../assets/mono/ice.webp'), sound: require('../assets/sounds/refri_flac/아이스크림.flac') },
   { id: 'imo', label: '고구마', imageSource: require('../assets/mono/imo.webp'), sound: require('../assets/sounds/refri_flac/고구마.flac') },
  { id: 'juice', label: '쥬스', imageSource: require('../assets/mono/juice.webp'), sound: require('../assets/sounds/refri_flac/쥬스.flac') },
  { id: 'kiwi', label: '키위', imageSource: require('../assets/mono/kiwi.webp'), sound: require('../assets/sounds/refri_flac/키위.flac') },
  { id: 'kori', label: '얼음', imageSource: require('../assets/mono/kori.webp'), sound: require('../assets/sounds/refri_flac/얼음.flac') },
  { id: 'kyuri', label: '오이', imageSource: require('../assets/mono/kyuri.webp'), sound: require('../assets/sounds/refri_flac/오이.flac') },
  { id: 'mandu', label: '만두', imageSource: require('../assets/mono/mandu.webp'), sound: require('../assets/sounds/refri_flac/만두.flac') },
  { id: 'milk', label: '우유', imageSource: require('../assets/mono/milk.webp'), sound: require('../assets/sounds/refri_flac/우유.flac') },
  { id: 'mush', label: '버섯', imageSource: require('../assets/mono/mush.webp'), sound: require('../assets/sounds/refri_flac/버섯.flac') },
  { id: 'orange', label: '오렌지', imageSource: require('../assets/mono/orange.webp'), sound: require('../assets/sounds/refri_flac/오렌지.flac') },
  { id: 'paprika', label: '파프리카', imageSource: require('../assets/mono/paprika.webp'), sound: require('../assets/sounds/refri_flac/파프리카.flac') },
  { id: 'peas', label: '콩', imageSource: require('../assets/mono/peas.webp'), sound: require('../assets/sounds/refri_flac/콩.flac') },
  { id: 'pepper', label: '고추', imageSource: require('../assets/mono/pepper.webp'), sound: require('../assets/sounds/refri_flac/고추.flac') },
  { id: 'pimang', label: '피망', imageSource: require('../assets/mono/pimang.webp'), sound: require('../assets/sounds/refri_flac/피망.flac') },

  { id: 'pizza', label: '피자', imageSource: require('../assets/mono/pizza.webp'), sound: require('../assets/sounds/refri_flac/피자.flac') },
  { id: 'pumpkin', label: '호박', imageSource: require('../assets/mono/pumpkin.webp'), sound: require('../assets/sounds/refri_flac/호박.flac') },
  { id: 'sakana', label: '고등어', imageSource: require('../assets/mono/sakana.webp'), sound: require('../assets/sounds/refri_flac/고등어.flac') },
  { id: 'sandwich', label: '샌드위치', imageSource: require('../assets/mono/sandwich.webp'), sound: require('../assets/sounds/refri_flac/샌드위치.flac') },
  { id: 'sangchu', label: '상추', imageSource: require('../assets/mono/sangchu.webp'), sound: require('../assets/sounds/refri_flac/상추.flac') },
  { id: 'tomato', label: '토마토', imageSource: require('../assets/mono/tomato.webp'), sound: require('../assets/sounds/refri_flac/토마토.flac') },  */

];

type QuizItem = (typeof MONO_ITEMS)[number];
const CARD_SLOTS = 6;
...
export default function RefriTestScreen() {
  ...
  const [remainingIds, setRemainingIds] = useState<string[]>(() => MONO_ITEMS.map((i) => i.id));
  const [slotItems, setSlotItems] = useState<(QuizItem | null)[]>(() => new Array(CARD_SLOTS).fill(null));
  ...
  const absorbAmount = Math.min(MAX_ABSORB, Math.floor((correctCount / totalProblems) * MAX_ABSORB));
  ...
  const startStarAnimation = useCallback(() => {
    ...
    const mainPulse = Animated.loop(
      Animated.sequence([
        Animated.parallel([
          Animated.timing(starMainScale, { toValue: 1.1, duration: 1000, useNativeDriver: true }),
          Animated.timing(starMainOpacity, { toValue: 1, duration: 1000, useNativeDriver: true }),
        ]),
        Animated.parallel([
          Animated.timing(starMainScale, { toValue: 0.9, duration: 1000, useNativeDriver: true }),
          Animated.timing(starMainOpacity, { toValue: 0.8, duration: 1000, useNativeDriver: true }),
        ]),
      ])
    );
    ...
    const sparkle1Blink = Animated.loop(
      Animated.sequence([
        Animated.delay(200),
        Animated.parallel([
          Animated.timing(sparkle1Scale, { toValue: 1.2, duration: 750, useNativeDriver: true }),
          Animated.timing(sparkle1Opacity, { toValue: 1, duration: 750, useNativeDriver: true }),
        ]),
        Animated.parallel([
          Animated.timing(sparkle1Scale, { toValue: 0, duration: 750, useNativeDriver: true }),
          Animated.timing(sparkle1Opacity, { toValue: 0, duration: 750, useNativeDriver: true }),
        ]),
      ])
    );
    ...
    const sparkle2Blink = Animated.loop(
      Animated.sequence([
        Animated.delay(700),
        Animated.parallel([
          Animated.timing(sparkle2Scale, { toValue: 1.2, duration: 750, useNativeDriver: true }),
          Animated.timing(sparkle2Opacity, { toValue: 1, duration: 750, useNativeDriver: true }),
        ]),
        Animated.parallel([
          Animated.timing(sparkle2Scale, { toValue: 0, duration: 750, useNativeDriver: true }),
          Animated.timing(sparkle2Opacity, { toValue: 0, duration: 750, useNativeDriver: true }),
        ]),
      ])
    );
    ...
    const sparkle3Blink = Animated.loop(
      Animated.sequence([
        Animated.delay(1200),
        Animated.parallel([
          Animated.timing(sparkle3Scale, { toValue: 1.2, duration: 750, useNativeDriver: true }),
          Animated.timing(sparkle3Opacity, { toValue: 1, duration: 750, useNativeDriver: true }),
        ]),
        Animated.parallel([
          Animated.timing(sparkle3Scale, { toValue: 0, duration: 750, useNativeDriver: true }),
          Animated.timing(sparkle3Opacity, { toValue: 0, duration: 750, useNativeDriver: true }),
        ]),
      ])
    );
    ...
    sparkle2Blink.start();
    sparkle3Blink.start();
  }, [starMainScale, starMainOpacity, sparkle1Scale, sparkle1Opacity, sparkle2Scale, sparkle2Opacity, sparkle3Scale, sparkle3Opacity]);
  ...
  const answerAnimations = useRef(
    MONO_ITEMS.reduce(
      ...
      {} as Record<string, { translateX: Animated.Value; translateY: Animated.Value; scale: Animated.Value; opacity: Animated.Value }>
    )
  ).current;
  ...
  const switchState = useCallback((newState: RefriState) => {
    console.log('🚪 switchState 호출:', newState, 'currentState:', currentState, 'isAnimating:', isAnimating);
  ...
  const startGaugeBlink = () => {
    ...
    blinkLoopRef.current = Animated.loop(
      Animated.sequence([
        Animated.timing(gaugeBlink, { toValue: 0.45, duration: 350, useNativeDriver: false }),
        Animated.timing(gaugeBlink, { toValue: 1, duration: 350, useNativeDriver: false }),
      ])
    );
  ...
  const pickRandomAndPlay = useCallback(async (pool: string[]) => {
    ...
    for (let i = 0; i < CARD_SLOTS; i++) slots.push(i < shuffled.length ? shuffled[i] : null);
  ...
  const animateCorrectAnswer = (id: string) => {
    ...
    ref.measure((ax, ay, aw, ah, aPageX, aPageY) => {
      fridgeRef.current?.measure((fx, fy, fw, fh, fPageX, fPageY) => {
        ...
        Animated.parallel([
          Animated.timing(anim.translateX, { toValue: moveX, duration: 520, useNativeDriver: true }),
          Animated.timing(anim.translateY, { toValue: moveY, duration: 520, useNativeDriver: true }),
          Animated.timing(anim.scale, { toValue: 0.3, duration: 520, useNativeDriver: true }),
  ...
  const handleSelectAnswer = (item: QuizItem) => {
    ...
    if (isCorrect) {
      ...
      if (anim) {
        Animated.sequence([
          Animated.timing(anim.scale, { toValue: 1.12, duration: 80, useNativeDriver: true }),
          Animated.spring(anim.scale, { toValue: 1, friction: 4, tension: 200, useNativeDriver: true }),
        ]).start();
      }
  ...
  const renderBackground = () => {
    if (!REFRI_RIVE_AVAILABLE) {
      return (
        <View style={{ width: LAYOUT.refriRiveWidth, height: LAYOUT.refriRiveHeight, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.2)' }}>
          <Text style={{ color: '#888', fontSize: 12 }}>배경 리소스 없음</Text>
          <Text style={{ color: '#666', fontSize: 10, marginTop: 4 }}>refri_bg.riv</Text>
        </View>
      );
    }
    return (
    ...
    if (!REFRI_RIVE_AVAILABLE) {
      return (
        <View style={{ width: LAYOUT.refriRiveWidth, height: LAYOUT.refriRiveHeight, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.2)' }}>
          ...
          <Text style={{ color: '#666', fontSize: 10, marginTop: 4 }}>refribon.riv</Text>
        </View>
      );
    }
    return (
  ...
  const renderCrates = () => {
    return (
      <View style={styles.cratesContainer}>
        {/* 왼쪽 상자 4단 스택 (아래부터 위로: 0, 1, 2, 3) */}
        <View style={styles.leftCrateStack}>
          <Animated.View style={[
            styles.crateWrapper,
            {
              opacity: crateOpacities[3],
              transform: [{ scale: crateScales[3] }]
            }
          ]}>
            <Image
              source={require('../../../assets/refri/crate_tall2x.webp')}
          ...
          <Animated.View style={[
            styles.crateWrapper,
            {
              opacity: crateOpacities[2],
              transform: [{ scale: crateScales[2] }]
            }
          ]}>
            <Image
              source={require('../../../assets/refri/crate_tall2x.webp')}
          ...
          <Animated.View style={[
            styles.crateWrapper,
            {
              opacity: crateOpacities[1],
              transform: [{ scale: crateScales[1] }]
            }
          ]}>
            <Image
              source={require('../../../assets/refri/crate_tall2x.webp')}
          ...
          <Animated.View style={[
            styles.crateWrapper,
            {
              opacity: crateOpacities[0],
              transform: [{ scale: crateScales[0] }]
            }
          ]}>
            <Image
              source={require('../../../assets/refri/crate_tall2x.webp')}
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <View style={styles.gaugeContainer}>
          <View style={styles.gaugeTrack}>
            ...
            <View style={[styles.gaugeMilestone, { left: '70%' }]}>
              <View style={[styles.milestoneIcon, { backgroundColor: '#43A047' }]} />
            </View>
            <View style={[styles.gaugeMilestone, { left: '90%' }]}>
              <View style={[styles.milestoneIcon, { backgroundColor: '#FB8C00' }]} />
            </View>
        ...
        <View style={styles.completeOverlay}>
          <View style={styles.completeBox}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.88}
            >
              <Ionicons name="refresh" size={LAYOUT.refriReplayIconSize} color="white" />
      ...
      {isGameStarted && (
        <View style={[styles.floatingReplayWrap, { bottom: insets.bottom + LAYOUT.refriBottomInsetOffset }]} pointerEvents="box-none">
          <TouchableOpacity
            style={styles.floatingReplayBtn}
            onPress={handleReplay}
            activeOpacity={0.88}
          >
            <Ionicons name="volume-high" size={LAYOUT.refriVolumeIconSize} color="#444" />
          </TouchableOpacity>
        </View>
      )}
      ...
      <View style={styles.answersContainer}>
        {slotItems.map((item, i) => {
          ...
          const anim = answerAnimations[item.id];
          if (!anim) return <View key={`slot-${i}`} style={{ width: cardWidth }} />;
          return (
            <View
              key={`slot-${i}`}
              ref={(node) => {
            ...
            >
              ...
              >
                ...
                >
                  <Image source={item.imageSource} style={styles.answerImage} resizeMode="contain" />
      ...
      {!isGameStarted && (
        <View style={[styles.controlSection, { paddingBottom: insets.bottom + LAYOUT.refriBottomInsetOffset }]}>
          <TouchableOpacity
            onPress={startGame}
            activeOpacity={0.88}
...
const styles = StyleSheet.create({
  ...
  crateWrapper: {
    marginBottom: LAYOUT.screenHeight * LAYOUT.refriCrateWrapperMarginBottomRatio,
